...
plot(names(daily_average), daily_average, type = "l", xlab = "5 minute intervals", ylab = "Average daily steps", col = "red", main = "Average daily activity")

max_steps <- which.max(daily_average)
